...
namespace SereneInventory.Inventory.Endpoints
{
    ...
    [RoutePrefix("Services/Inventory/TransactionDetail"), Route("{action}")]
    ...
    public class TransactionDetailController : ServiceEndpoint
    {
		...
		public FileContentResult ListExcel(IDbConnection connection, ListRequest request) {
            ...
            return ExcelContentResult.Create(bytes, "TransactionDetailList_" + DateTime.Now.ToString("yyyyMMdd_HHmmss") + ".xlsx");
        }
    }
}
